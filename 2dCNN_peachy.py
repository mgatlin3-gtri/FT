...
config={
    ...
    "epochs": 100, # number of times the model passes through the entire training dataset
    "dropout_c": 0.35, # dropout from convolutional layers
    "dropout_ga": 0.2, # dropout from global averaging layer
    "num_features_c1": 128, # ""
    "num_features_c2": 16, # sizes of feature maps in respective convolutional blocks
    "num_features_c3": 32, # ""
    "num_features_c4": 32, # ""
...
json.dump(history.history, open('peachy-model_history.json', 'w'))
