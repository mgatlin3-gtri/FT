...
model_file = 'zesty-14.h5'
# hyper-parameter configuration for Weights and Biases
config={
    "batch_size": 64, # number of images processed during training before weights update
    "epochs": 60, # number of times the model passes through the entire training dataset
    "dropout_c": 0.1, # dropout from convolutional layers
    "dropout_ga": 0.35, # dropout from global averaging layer
    "num_features_c1": 128, # ""
    "num_features_c2": 32, # sizes of feature maps in respective convolutional blocks
    "num_features_c3": 32, # ""
    "num_features_c4": 128, # ""
    "learning_rate": 0.005
}
...
json.dump(history.history, open('zesty-model_history.json', 'w'))
